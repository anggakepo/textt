...
def main():
    ...
    processed_tokens = set()  # To keep track of processed tokens

    while True:
        init_data_raw = next(token_cycle)

        # Stop if all tokens are processed
        if init_data_raw in processed_tokens:
            print(Fore.LIGHTGREEN_EX + "All tokens have been processed. Exiting...")
            break
        ...
        if response.status_code == 200:
            ...
            processed_tokens.add(init_data_raw)
